 ...
 * 
 //I had a hard time figuring out how to install ncurses on vscode and found out the command from this website: https://askubuntu.com/questions/270381/how-do-i-install-ncurses-header-files
 
 */
#include "AirportAnimator.hpp"

#include <assert.h>
#include <ncurses.h> // on OS/X replace with #include<curses.h>
#include <pthread.h>
#include <string>
#include <time.h>
#include <unistd.h>
...
void
AirportAnimator::updateStatus(int plane_num, const string &status)
{
  lockScreen();
