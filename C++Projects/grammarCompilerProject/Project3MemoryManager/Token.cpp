...
Author : Max Hoffman implemented get() method, S. Blythe 12/2023 provided stype, print and variables
Date : 1/28/2024 - 2/11/2024
Purpose:  Create a parser to beautify an .txt file input and output the beautified file if it is correct syntax, works with 
Grammar files to parse txt files.

Reused from Project 2 & Project 1 Unchanged
